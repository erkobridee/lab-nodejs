...
console.log( shortHash('client0100@dom.ext') );
console.log( shortHash('0100client@dom.ext') );
console.log( shortHash('client@0100dom.ext') );
console.log( shortHash('client01@dom.ext') );
console.log( shortHash('01client@dom.ext') );
console.log( shortHash('cli01ent@dom.ext') );
console.log( shortHash('clien01t@dom.ext') );
console.log( shortHash('client01@dom.ext') );
console.log( shortHash('01client@dom.ext') );
console.log( shortHash('cli01ent@dom.ext') );
console.log( shortHash('clien01t@dom.ext') );
...
console.log( shortHash(['clien01t@dom.ext', 'clien02t@dom.ext']) );
console.log( shortHash(['clien02t@dom.ext', 'clien01t@dom.ext']) );
