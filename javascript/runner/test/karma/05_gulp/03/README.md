# Karma Runner / 05 gulp / 03

> Karma Runner and require.js application with Gulp. Tests spec's loaded by `tests/require.specs.load.js` added on require config deps array.
